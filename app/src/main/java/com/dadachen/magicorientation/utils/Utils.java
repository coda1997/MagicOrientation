...
public class Utils {
    ...
    public static void setValueBySharedPreference(SharedPreferences sharedPreference, String key, boolean value) {
        sharedPreference.edit().putBoolean(key, value).apply();
    }

    public static void setValueBySharedPreference(SharedPreferences sharedPreference, String key, String value) {
        sharedPreference.edit().putString(key, value).apply();
    }
    public static void setValueBySharedPreference(SharedPreferences sharedPreference, String key, int value) {
